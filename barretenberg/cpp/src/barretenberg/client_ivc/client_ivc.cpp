        ...
        const std::shared_ptr<RecursiveTranscript>& accumulation_recursive_transcript)
{
    ...
    case QUEUE_TYPE::OINK: {
        ...
        merge_commitments.T_prev_commitments = stdlib::recursion::honk::empty_ecc_op_tables<ClientCircuit>(circuit);
...
bool ClientIVC::verify(const Proof& proof, const VerificationKey& vk)
{
    ...
    auto [mega_verified, T_prev_commitments] = verifier.verify_proof_hiding_kernel(proof.mega_proof);
