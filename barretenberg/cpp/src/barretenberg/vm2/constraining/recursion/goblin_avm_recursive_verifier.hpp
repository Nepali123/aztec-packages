  ...
  public:
                                                   ...
                                                   const InnerProverOutput& inner_output) const
    {
        ...
        MergeCommitments merge_commitments{
            ...
            .T_prev_commitments = stdlib::recursion::honk::empty_ecc_op_tables<UltraBuilder>(
        ...
        mega_verifier_output.mega_inputs_hash.assert_equal(ultra_hash);

        // Return ipa proof, ipa claim and output aggregation object produced from verifying the Mega + Goblin proofs
        RecursiveAvmGoblinOutput output{ .points_accumulator = goblin_verifier_output.points_accumulator,
        ...
        const stdlib::Proof<UltraBuilder>& stdlib_proof, const std::vector<std::vector<UltraFF>>& public_inputs) const
    {
        ...
        // Public inputs
        IO inputs;
        inputs.mega_inputs_hash = mega_input_hash;
